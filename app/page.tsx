...
export default function YoguiAiLanding() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-amber-50 to-orange-50 overflow-x-hidden">
      ...
      <header className="container mx-auto px-4 py-2 md:py-3 max-w-full">
        <div className="flex justify-center">
          <Image
            ...
            width={900}
            height={360}
            className="h-40 sm:h-48 md:h-56 lg:h-64 w-auto max-w-full"
          />
        </div>
      </header>

      {/* Hero Section */}
      <section className="container mx-auto px-4 py-6 md:py-12 lg:py-16 max-w-full">
        <div className="grid lg:grid-cols-2 gap-6 lg:gap-12 items-center max-w-7xl mx-auto">
          <div className="text-center lg:text-left space-y-4 md:space-y-6 order-2 lg:order-1 px-2">
            <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl font-light text-amber-900 leading-tight break-normal">
              Tu asistente virtual para{" "}
              <span className="block font-medium text-amber-800">potenciar tu energía vital</span>
            </h1>

            <p className="text-base sm:text-lg md:text-xl lg:text-2xl text-amber-700 leading-relaxed max-w-2xl mx-auto lg:mx-0 break-normal">
      ...
      <section className="bg-gray-50 py-12 md:py-16 lg:py-20">
        <div className="container mx-auto px-4 max-w-full">
          <div className="text-center mb-12 md:mb-16 max-w-4xl mx-auto">
            <h2 className="text-2xl md:text-3xl lg:text-4xl font-light text-amber-900 mb-4 md:mb-6 px-2 break-normal">
              Tres pilares para tu bienestar
            </h2>
            <p className="text-base md:text-lg lg:text-xl text-amber-700 px-2 break-normal">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8 max-w-6xl mx-auto">
            <Card className="border-0 shadow-sm bg-amber-50 hover:shadow-md transition-shadow">
              <CardContent className="p-6 md:p-8 text-center">
                ...
                <h3 className="text-xl md:text-2xl font-medium text-amber-900 mb-3 md:mb-4 break-normal">Movimiento</h3>
                <p className="text-amber-700 leading-relaxed text-base md:text-lg break-normal">
            ...
            <Card className="border-0 shadow-sm bg-orange-50 hover:shadow-md transition-shadow">
              <CardContent className="p-6 md:p-8 text-center">
                ...
                <h3 className="text-xl md:text-2xl font-medium text-amber-900 mb-3 md:mb-4 break-normal">Mente</h3>
                <p className="text-amber-700 leading-relaxed text-base md:text-lg break-normal">
            ...
            <Card className="border-0 shadow-sm bg-amber-50 hover:shadow-md transition-shadow">
              <CardContent className="p-6 md:p-8 text-center">
                ...
                <h3 className="text-xl md:text-2xl font-medium text-amber-900 mb-3 md:mb-4 break-normal">Conexión</h3>
                <p className="text-amber-700 leading-relaxed text-base md:text-lg break-normal">
      ...
      <section className="py-12 md:py-16 lg:py-20 bg-gradient-to-r from-amber-100 to-orange-100">
        <div className="container mx-auto px-4 max-w-full">
          <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center max-w-7xl mx-auto">
            ...
            <div className="order-1 lg:order-2 space-y-4 md:space-y-6 text-center lg:text-left">
              <h2 className="text-2xl md:text-3xl lg:text-4xl font-light text-amber-900 px-2 break-normal">
              ...
              <div className="space-y-4 md:space-y-6">
                <div className="space-y-2 md:space-y-3">
                  <div className="flex items-center justify-center lg:justify-start gap-2 flex-wrap">
                    <h3 className="text-base md:text-lg lg:text-xl font-medium text-amber-900 break-normal">
                      Conversación por WhatsApp
                    </h3>
                    <MessageCircle className="w-5 h-5 md:w-6 md:h-6 text-amber-900 flex-shrink-0" />
                  </div>
                  <p className="text-amber-700 text-sm md:text-base lg:text-lg px-2 lg:px-0 break-normal">
      ...
      {/* CTA Section */}
      <section id="formulario" className="py-12 md:py-16 lg:py-20 bg-gray-50 text-amber-900">
        <div className="container mx-auto px-4 text-center max-w-full">
          <div className="max-w-3xl mx-auto space-y-6 md:space-y-8">
            <h2 className="text-2xl md:text-3xl lg:text-4xl font-light px-2 break-normal">
              Yogui estará disponible pronto
            </h2>

            <p className="text-base md:text-lg lg:text-xl text-amber-800 leading-relaxed px-2 break-normal">
              ...
              <CardContent className="p-4 md:p-6">
                <form action={formAction} className="space-y-3 md:space-y-4">
                  ...
                  {state && (
                    ...
                    >
                      <p className="text-sm md:text-base font-medium break-normal">{state.message}</p>
                    </div>
                  )}
                </form>
              </CardContent>
